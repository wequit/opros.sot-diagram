...
import Breadcrumb from "@/lib/utils/breadcrumb/BreadCrumb"; // Импортируем Breadcrumb
...
const SecondInstance = () => {
  ...
  const { setCourtName, setSurveyData, setIsLoading, selectedCourt, setSelectedCourt } =
    useSurveyData();
